...
export default function DashProfile() {
    ...
    const handleImageChange = (e) => {
        ...
        if (file) {
            console.log("this file image success hits");
            setImageFile(file);
            const imageUrl = URL.createObjectURL(file);
            setImageFileUrl(imageUrl);
            console.log("imageFile", file, "imageFileUrl", imageUrl);
        }
    }
    useEffect(() => {
        if (imageFile) {
    ...
    const uploadImage = async () => {
        ...
        uploadTask.on('state_changed', (snapshot) => {
            ...
            () => getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
                ...
                console.log("this is image url", downloadURL)
    ...
    return (
        <div className="'max-w-lg mx-auto p-3 w-full">
            ...
            <form className="flex flex-col gap-4 ">
                ...
                <div className="relative w-32 h-32 self-center cursor-pointer shadow-md overflow-hidden rounded-full gap-4 "
